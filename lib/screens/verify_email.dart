            ...
            child: Stack(
              children: [
                Container(
                      ...
                      children: [
                        Positioned(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text("Why Verification?",style: GoogleFonts.poppins(color: Colors.white,shadows:  <Shadow>[
                          const Shadow(
                          offset: Offset(1.0, 2.0),
                            ...
                            color: Colors.white,
                              ...
                              Text("It ensures security and access\n             to your account.",style: GoogleFonts.poppins(color: Colors.white),).text.bold.size(16).make(),
                      ...
                      child: Form(
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              Text("Verify your email",style: GoogleFonts.lato(color: Color(0xff9163D7)),).text.size(24).bold.make().p(20),
                              Text("We have sent you a code by email",style: GoogleFonts.lato(color: Colors.grey),).text.size(19).make().p(20),
                              Padding(
                  ...
                  await HttpService.verifyCode(widget.email, context);
...
//navigating next page for verification of email
                  Navigator.pushNamed(context, VerifyEmail.routeName);
                              ...
                              Row(
                                ...
                                children: [
                                  Text("Didnt you receive any code? ",style: GoogleFonts.lato(),).text.gray500.make(),
                                  TextButton(
